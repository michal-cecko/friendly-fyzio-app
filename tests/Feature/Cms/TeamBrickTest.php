...
class TeamBrickTest extends TestCase
{
    ...
    {
        $published = User::factory()->create(['name' => 'Petra Publikovaná']);
        StaffProfile::factory()->create(['user_id' => $published->getKey(), 'published_at' => now()->subDay()]);

        $draft = User::factory()->create(['name' => 'Dana Rozpracovaná']);
        StaffProfile::factory()->create(['user_id' => $draft->getKey(), 'published_at' => null]);

        User::factory()->create(['name' => 'Nora Bezprofilová']);
    ...
    {
        $admin = User::factory()->admin()->therapist()->create(['name' => 'Alena Adminová']);
