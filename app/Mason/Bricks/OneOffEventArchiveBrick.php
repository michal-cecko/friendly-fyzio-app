 ...
 * happened" tail (handled by the OneOffEventArchive Livewire component).
 ...
 */
class OneOffEventArchiveBrick extends Brick
{
    ...
    {
        return 'Archiv jednorázových akcí';
    }
    ...
    {
        return view('bricks.event-archive', ['config' => $config])->render();
    }
