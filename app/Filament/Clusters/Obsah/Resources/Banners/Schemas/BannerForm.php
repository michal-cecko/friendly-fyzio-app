    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                PresenceBanner::make(),
                Grid::make(2)
                    // The resource form's root schema is 2 columns; a Grid does not
                    // span it in full by default (unlike a Section), so pin it wide.
                    ->columnSpanFull()
                    ->schema([
                        // The two short sections stack in the left column so they
                        // sit flush together instead of leaving a big gap next to
                        // the long "Obsah banneru" section on the right.
                        Group::make()
                            ->schema([
                                Section::make('Banner')
                                    ->columns(2)
